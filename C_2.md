...
<div align="center">
   <img src="images/Deep_Learning_ND_P1_C_2_02.png" alt="Board" width="600" height=auto/>
...
<div align="center">
   <img src="images/Deep_Learning_ND_P1_C_2_01.png" alt="Activation Functions" width="600" height=auto/>
   <p>Figure: Activation Functions</p>
</div>
...
The original error function for binary classification looks like this:
...
<div align="center">
   <img src="images/Deep_Learning_ND_P1_C_2_04.png" width="600" height=auto/>
...
$$E_{L1}(W, b) = -\frac{1}{m} \sum_{i=1}^{m} [(1 - y_i) \ln(1 - \hat{y}_i) + y_i \ln(\hat{y}*i)] + \lambda \sum*{j=1}^{n} |w_j|$$
...
$$E_{L2}(W, b) = -\frac{1}{m} \sum_{i=1}^{m} [(1 - y_i) \ln(1 - \hat{y}_i) + y_i \ln(\hat{y}*i)] + \lambda \sum*{j=1}^{n} w_j^2$$
